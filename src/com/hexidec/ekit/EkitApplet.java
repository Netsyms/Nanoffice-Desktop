...
public class EkitApplet extends JApplet {
    ...
    public void init() {
        ...
        if (this.getParameter("TOOLBARSEQ") != null) {
            toolbarSeq = this.getParameter("TOOLBARSEQ").toUpperCase();
        }
        boolean enterBreak = false;
        if (this.getParameter("ENTERBREAK") != null) {
            enterBreak = this.getParameter("ENTERBREAK").equalsIgnoreCase("true");
        }
     ...
     * is the entire document, including the top-level HTML tags.
     */

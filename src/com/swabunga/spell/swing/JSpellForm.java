 ...
 * <p>
 * This needs to layed out correctly but for the most part it works.</p>
 *
 * @author Jason Height (jheight@chariot.net.au)
 *
 * NOTE: Modification be Howard Kistler: Removed the calls that change the
 * Invalid Word text box, because I think that behaviour is counter-intuitive
 * and might even screw up other functions that rely on it being the original
 * invalid word. If it's going to be like this for good, it should probably be a
